      ...
      <Layout border>
        <div className="container my-20">
          <div className="max-w-3xl space-y-3 m-auto">
            ...
            <p className="dark:text-slate-400">{seminars?.[0]?.description}</p>
            ...
            >
              <div className="grid grid-cols-2 gap-5">
                ...
                <div className="space-y-2">
                  <Label htmlFor="occupation">সর্বশেষ শিক্ষাগত যোগ্যতা</Label>
                  <Controller
                    name="occupation"
                    control={control}
                    render={({ field }) => (
              ...
              <p className="dark:text-slate-400 text-sm">
                [নোট: যদি পেশা স্টুডেন্ট হয় তাহলে প্রতিষ্ঠান হবে আপনার শিক্ষা
                প্রতিষ্ঠান। আর যদি পেশা চাকরি বা অন্য কিছু হয় তাহলে প্রতিষ্ঠান
                হবে আপনি যে প্রতিষ্ঠানে কর্মরত।]
              </p>
              <div>
                <Button
                  type="submit"

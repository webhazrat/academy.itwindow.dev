...
export default function Login() {
  ...
  return (
    <>
      <Head>
        <title>Login | ITWINDOW - Enhance Yourself</title>
      </Head>
          ...
          <div>
            <div className="space-y-12 hidden">
              <div>
                ...
                <p className="dark:text-slate-400">
                  ...
                  কোর্সগুলো নিয়ে নিজের ভবিষ্যত কর্মজীবনকে আগিয়ে নিতে পারেন নিজের
                  মত করে।
                </p>
              </div>
            ...
            <div className="mt-4">
              ...
              <div className="space-y-3">
                ...
                <div className="py-2">
                  <p className="flex items-center gap-3 dark:text-slate-400">
                    <Checkbox /> আমি এই প্লাটফর্মের রিফান্ড পলিসি সহ সকল শর্ত
                    মেনে নিচ্ছি
                  </p>
                </div>
                <Button className="bg-gradient text-white">সাবমিট করুন</Button>
